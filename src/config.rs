...
pub struct Theme {
    ...
    pub match_hl:    Color32, // highlight color for search-match text
}
...
fn kanagawa() -> Theme {
    Theme {
        ...
        match_hl:      c(0xD2, 0x7E, 0x99), // sakura pink
    }
}
...
fn gruvbox() -> Theme {
    Theme {
        ...
        match_hl:      c(0xB8, 0xBB, 0x26), // bright green
    }
}
...
fn nord() -> Theme {
    Theme {
        ...
        match_hl:      c(0xA3, 0xBE, 0x8C), // aurora green
    }
}
...
fn tokyonight() -> Theme {
    Theme {
        ...
        match_hl:      c(0xFF, 0x00, 0x7C), // magenta/pink
    }
}
...
fn dracula() -> Theme {
    Theme {
        ...
        match_hl:      c(0xFF, 0x79, 0xC6), // pink
    }
}
...
fn solarized() -> Theme {
    Theme {
        ...
        match_hl:      c(0xD3, 0x36, 0x82), // magenta
    }
}
...
fn monokai() -> Theme {
    Theme {
        ...
        match_hl:      c(0xF9, 0x26, 0x72), // pink
    }
}
...
fn catppuccin() -> Theme {
    Theme {
        ...
        match_hl:      c(0xF3, 0x8B, 0xA8), // pink
    }
}
...
fn onedark() -> Theme {
    Theme {
        ...
        match_hl:      c(0x98, 0xC3, 0x79), // green
    }
}
...
fn rosepine() -> Theme {
    Theme {
        ...
        match_hl:      c(0xEB, 0x6F, 0x92), // love (pink)
    }
}
